...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-6 col-md-4">
                            <!--<h1 class="my-0 site-logo" style ='font:11px/21px Monospace,tahoma,helvetica;color:#ff964b00'>><a href="index.html">Zakiyah Batik<span
                                        class="text-primary"></span>
                                </a></h1>-->
                            <h1 href="www.zakiyahbatik.com" style="font-family:Snell Roundhand, cursive;color:#964b00">Zakiyah Batik
                                </h1>
                        </div>
        ...
        <div class="site-blocks-cover" id="home-section">
            <div class="img-wrap" style="max-height:95%">
                <div class="owl-carousel slide-one-item hero-slider">
                    <div class="slide overlay">
                        <img src="{{ url('/storage/Slides/' . $set->Slide1) }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="slide overlay">
                        <img src="{{ url('/storage/Slides/' . $set->Slide2) }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="slide overlay">
                        <img src="{{ url('/storage/Slides/' . $set->Slide3) }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="slide overlay">
                        <img src="{{ url('/storage/Slides/' . $set->Slide4) }}" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="container">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5">
                        <img src="{{ url('/storage/Slides/Logo3.png') }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="col-lg-5 ml-auto section-title">
                        <span class="sub-title mb-2 d-block">Tentang Kami</span>
                        <h2 class="title mb-3" style="font-family:Snell Roundhand, cursive;color:#964b00">Zakiyah Batik.</h2>
                        <p class="mb-4">{{ $set->Tentang }}</p>
                        <p><b>Lokasi : </b> Jl. Raya Candi VI C No.12, Karangbesuki, Kec. Sukun, Kota Malang, Jawa Timur 65149</p>
                        <p><b>Kontak : </b>(+62) 85854302115 (<b>Ibu Zakiyah</b>)</p>
                        <embed
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-center">
                                    <a target="_blank" href="{{ $set->LinkFacebook }}"
                            ...
                            <div class="col-md-6">
                                <p class="text-center">
                                    <a target="_blank" href="{{ $set->LinkInstagram }}"
                                        class="d-flex align-items-center"><span
                                            class="icon-instagram h4 m-0 mr-2"></span>
                            ...
                            <div class="col-md-6">
                                <p class="text-center">
                                    <a target="_blank" href="{{$set->LinkInstagram2}}"
                                        class="d-flex align-items-center"><span
                                            class="icon-instagram h4 m-0 mr-2"></span>
                                        <!--class="icon-facebook h4 m-0 mr-2"></span>-->
                                        <span>{{$set->Instagram2}}</span>
                                    </a>
                                </p>
                            </div><br>
                        </div>
        ...
        <div class="bg-light" id="what-we-do-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label>Gender</label>
                        <select class="form-control" id="gender" onchange="filter()">
                            <option></option>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" id="kategori" onchange="filter()">
                            <option></option>
                            @foreach ($kat as $k){
                            ...
                            @foreach ($datas as $d)
                                <div class="col-md-4 col-lg-4 mb-4 mb-lg-4">
                                    <div class="service h-100">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h6 class="text-center">&nbsp; Rp. {{ number_format($d->ProdukHarga, 0, '', '.') }}
                                                </h6>
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <a target="_blank" href="https://wa.me/6285854302115?text=Assalamu'alaikum,%20Stok%20Barang%20{{ $d->ProdukNama }}%20Kode%20{{ $d->ProdukKode }}%20ready?" class="text-center">
                                                    <span><b>Chat me</b></span>
                                            </a>
                                        </div>
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <div class="row mb-5">
                        <div class="col-12">
                            ...
                            <p>Sebagai Pusat Fashion Batik Online di Asia, kami menciptakan motif batik baru dan memperluas jangkauan produk,
                            mulai dari produk internasional hingga produk lokal dambaan. Kami menjadikan Anda sebagai pusatnya. Bersama <strong>Zakizah Batik.</strong> </p>
                            <p>Lokasi : Jl. Raya Candi VI C No.12, Karangbesuki, Kec. Sukun, Kota Malang, Jawa Timur 65149</p>
                            <p>Kontak : (+62) 85854302115 (Ibu Zakiyah)</p>
                        </div>
                    </div>
   ...
   <a href="#" class="pl-3 pr-3"><span class="icon-twitter"></span></a> -->
                        <a href="https://www.instagram.com/zakiyahbatik/" target="_blank"
                            class="pl-3 pr-3"><span class="icon-instagram"></span> Zakiyah Batik</a>
                        <a href="https://instagram.com/supplierbatikmadura/" target="_blank"
                            class="pl-3 pr-3"><span class="icon-instagram"></span> Supplier Batik Madura</a>
                        <a href="https://instagram.com/batiktopengmalangan/" target="_blank"
                            class="pl-3 pr-3"><span class="icon-instagram"></span> Batik Topeng Malangan</a>
                    ...
                    <p>
                        ...
                        </script> All rights reserved | This web develop by
                        <i class="icon-heart-o" aria-hidden="true"></i> <a href="https://msubianto.blogspot.com/"
                            target="_blank">Byan_LA</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
    ...
    <script>
        ...
        function filter() {
            ...
            console.log("Gender Acquired:" + gender);
            console.log("Kategori Acquired:" + kategori);
            $.ajax({
                url: "/filter",
                type: "GET",
                data: {
